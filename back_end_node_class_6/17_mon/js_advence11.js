...
app.get('/', (req, res) => {
    res.render('js_advence12', { title: '폼 실습을 해봅시다'});
})

app.get('/getForm', (req, res) => {
    console.log(req.query); // { id: 'banana', pw: '1234' }
    // res.send('get 요청 성공!')
    res.render('js_advence13', { title: 'GET 요청 결과', userInfo: req.query });
...
app.post('/postForm', (req, res) => { 
    ...
    // res.send('post 요청 성공!')
    res.render('js_advence13', { title: 'POST 요청 결과', userInfo: req.body } )
})
