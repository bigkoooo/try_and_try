...
-- ('BC(기업)카드', '[IBK기업은행] K-패스(체크)', NULL, '대중교통 건당 100원 할인', '후불교통카드로 이용한 건에 한함 (환승요금 제외). 매출표 접수일 기준으로 월 최대 1천원 할인(월 10회 한도)', true, NULL, '편의점(GS25, CU, 세븐일레븐, 올리브영) 10% 할인', '통합 1일 1회, 월 2회, 1회 이용금액 1만원 한도. 온라인(간편결제 등) 결제 건은 할인 제외', true,  NULL, '커피(스타벅스, 커피빈, 카페베네, 탐앤탐스, 엔제리너스, 투썸플레이스, 할리스, 달.콤) 10% 할인', '통합 1일 1회, 월 2회, 1회 이용금액 1만원 한도. 현장결제와 각 커피 브랜드의 공식앱을 통한 온라인 결제 건에 한함. 커피 브랜드의 상품권, 선불카드 구입/충전 제외. 백화점 및 할인(아울렛)점 입점 매장은 제외', true,  3, '', '', false, NULL, '', '', false, NULL, '전월 이용실적이 30만원 이상인 경우 제공', '전월 이용실적이 30만원 이상인 경우 제공', true),
-- -- 구독 혜택 top 3
...
-- ('대구은행(IM뱅크)', 'Master Y+(영플러스) 체크카드', NULL, '', '', false, NULL, 'CU, GS 25 5% 결제일 캐시백', '건당 최소이용금액 1만원 이상, 최대 2만원까지 할인 적용. 1회 최대 1,000원 할인. 서비스 제공처 통합 월 3회', true, NULL, '스타벅스 20% 결제일 캐시백', '건당 최소이용금액 1만원 이상, 최대 2만원까지 할인 적용. 1회 최대 4,000원 할인. 서비스 제공처 통합 월 3회. 대형마트, 백화점, 쇼핑몰, 역사 입점 점포 제외. 상품권(선불카드) 구매 시 제외', true,  NULL, '', '', false, NULL, '교보문고 매장구입시 2천원 결제일 캐시백', '교보문고 오프라인 매장에서 구매시 2천원 결제일 캐시백. 건당 4만원 이상 결제 시 할인 적용. 토익응시료 2천원 결제일 캐시백. 서적할인,토익응시료 할인 합산 연 6회 제공', true, 2, '전월실적 20만원 이상', '상기 전월 이용실적은 해당 대구은행 YOUNG PLUS(Y+)체크카드로 전월(결제일 관계없이 1일~말일) 국내가맹점 이용실적(선불교통충전금액,교통요금,제세공과금,APT관리비,대학등록금 제외) 입니다. Y+체크카드 신규발급 회원은 발급월 포함하여 2개월간 이용금액에 상관없이 최소 구간 서비스를 제공하며, 전월실적이 최소구간 이상인 경우 해당상위 기준을 적용 합니다. Y+체크카드 월간통합할인한도는 전월실적에 따라 매월 변경 적용되며, 익월로 이월되거나 포인트 적립, 캐시백 등으로 전환되지 않습니다. 전월실적 20만원 이상 ~ 30만원 미만일 경우 월간 최대 1만원까지 할인. 전월실적 30만원 이상 ~ 50만원 미만일 경우 월간 최대 2만원까지 할인', true),
-- ('하나카드', '리틀프렌즈 체크카드', NULL, '', '', false, NULL, '편의점(CU, GS25, 세븐일레븐) 월 2회, 연 6회 1,000원', '편의점 건당 1000원 할인', true, NULL, '', '', false, NULL, '', '', false, NULL, '서점(영풍문고, 반디앤루니스, 교보문고) 월 2회, 연 6회 1,000원', '서점 1000원 할인', true, 3, '난달 1일부터 말일까지(승인시점 기준)의 이용금액 10만원 이상 시 서비스 제공', '난달 1일부터 말일까지(승인시점 기준)의 이용금액 10만원 이상 시 서비스 제공', true);
